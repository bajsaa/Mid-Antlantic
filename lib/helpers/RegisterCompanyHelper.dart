...
class RegisterCompanyHelpers with ChangeNotifier{
  ...
  Widget registerCompanyAppBar(BuildContext context){
    return AppBar(
      ...
      title: Text("Register Your Company", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold,color: Colors.black)),
      actions: [
        IconButton(
  ...
  Widget registerCompanyBody(BuildContext context) {
