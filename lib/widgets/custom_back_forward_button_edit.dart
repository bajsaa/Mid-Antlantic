...
class CustomBackForwardDirectionEditBtn extends StatelessWidget {
  final String text;
  final Function onPressed;
  final bool outlineBtn;
  final bool isLoading;

  CustomBackForwardDirectionEditBtn({this.text, this.onPressed, this.outlineBtn, this.isLoading});
